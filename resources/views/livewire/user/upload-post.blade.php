    ...
    <form wire:submit="uploadPost">
        <div class="space-y-2 py-2">
            ...
            <div class="w-full mx-auto">
                ...
                <select id="categories[]" name="categories[]" wire:model.blur="form.categories" wire:ignore x-data="
                                {
                                    select:
                                    new Select(
